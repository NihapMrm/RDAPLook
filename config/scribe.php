...
return [
    ...
    'description' => 'RDAPLook — Domain intelligence API powered by RDAP (the modern WHOIS replacement) and DNS lookups.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Pass your API key in the <code>X-API-Key</code> header. Get your key from the RDAPLook dashboard.',
    ],
